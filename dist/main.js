...
function createTaskForm(toDoList, tasksCounter) {
    ...
    taskSubmitButton.addEventListener('click', (e) => {
        ...
        const newProject = new _projects__WEBPACK_IMPORTED_MODULE_1__.Project(projectNameInput, projectDueInput);
