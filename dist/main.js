...
/* harmony import */ var _addEventListeners__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addEventListeners */ "./src/addEventListeners.js");
...
const toDoList = new _toDoList__WEBPACK_IMPORTED_MODULE_2__.ToDoList();

// Create new projects
const project1 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('Phoenix Rising', 'May 15, 2023');
const project2 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('Quantum Leap', 'May 30, 2023');
const project3 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('The Atlas Project', 'June 10, 2023');
const project4 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('ChronoScope', 'July 1, 2023');
const project5 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('Eureka', 'July 15, 2023');
const project6 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('The Quantum Paradox', 'August 1, 2023');
const project7 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('Project Athena', 'August 15, 2023');
const project8 = new _projects__WEBPACK_IMPORTED_MODULE_4__.Project('Zephyr', 'September 1, 2023');

// Create new tasks
const task1 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 1', 'May 13, 2023', 'Medium', 'Do this task first');
const task2 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 2', 'May 17, 2023', 'High', 'This task is urgent');
const task3 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 3', 'May 28, 2023', 'Low', 'Not a priority');
const task4 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 4', 'June 5, 2023', 'High', 'Needs to be completed before project deadline');
const task5 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 5', 'June 25, 2023', 'Medium', 'Some urgency, but not critical');
const task6 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 6', 'July 7, 2023', 'High', 'Critical task for project success');
const task7 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 7', 'August 1, 2023', 'Low', 'Not a priority, but needs to be done eventually');
const task8 = new _tasks__WEBPACK_IMPORTED_MODULE_3__.Task('Task 8', 'August 20, 2023', 'Medium', 'Some urgency, but can wait');
...
toDoList.addProject(project8);
    ...
    (0,_projectListLoad__WEBPACK_IMPORTED_MODULE_0__.projectListLoad)(toDoList.projects);
    (0,_addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListeners)();
}
