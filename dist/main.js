...
/* harmony export */ });
/* harmony import */ var _projectFormDisplay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectFormDisplay */ "./src/projectFormDisplay.js");
...
function addProjectButton() {
    ...
    addButton.addEventListener('click', (e) => {
        (0,_projectFormDisplay__WEBPACK_IMPORTED_MODULE_0__.projectFormDisplay)();
    })
...
/* harmony import */ var _addProjectButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addProjectButton */ "./src/addProjectButton.js");



function firstPageLoad() {
    (0,_addProjectButton__WEBPACK_IMPORTED_MODULE_1__.addProjectButton)();
    (0,_projectListLoad__WEBPACK_IMPORTED_MODULE_0__.projectListLoad)();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "projectFormDisplay": () => (/* binding */ projectFormDisplay)
/* harmony export */ });
/* harmony import */ var _projectListLoad__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectListLoad */ "./src/projectListLoad.js");
...
form.appendChild(projectDueDateInput);
  ...
  form.addEventListener('submit', (event) => {
    ...
    const project = new _projects__WEBPACK_IMPORTED_MODULE_1__.Project(projectName, projectDueDate);
    ...
    for (const taskInput of taskInputs) {
      ...
      // Create a new task
      const task = new _tasks__WEBPACK_IMPORTED_MODULE_2__.Task(taskName, taskDueDate, taskPriority, taskNotes);
...
/* harmony import */ var _projectFormDisplay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./projectFormDisplay */ "./src/projectFormDisplay.js");
...
function createTaskList(project) {
  ...
  for (let i = 0; i < project.tasks.length; i++) {
    ...
    const projectIndex = _projects__WEBPACK_IMPORTED_MODULE_0__.projects.indexOf(project);
    const taskIndex = i;
    ...
    taskDeleteButton.addEventListener('click', (e) => {
      if (e.target && e.target.id.startsWith('taskDelete ')) {
        ...
        _projects__WEBPACK_IMPORTED_MODULE_0__.projects[projectIndexUse].tasks.splice(taskIndexUse, 1);
...
function createProjectListItem(project, buttonID) {
  ...
  editButton.addEventListener('click', (e) => {
    if (e.target && e.target.id.startsWith('Edit ')) {
      const index = e.target.id.split(' ')[1];
      const selectedProject = _projects__WEBPACK_IMPORTED_MODULE_0__.projects[index];
      (0,_projectFormDisplay__WEBPACK_IMPORTED_MODULE_1__.projectFormDisplay)(selectedProject);
    }
  });
...
function projectListLoad() {
  ...
  for (let i = 0; i < _projects__WEBPACK_IMPORTED_MODULE_0__.projects.length; i++) {
    const project = _projects__WEBPACK_IMPORTED_MODULE_0__.projects[i];
    const buttonID = `${i}`;
...
class Project {
    constructor(name, due) {
        this.name = name;
        this.due = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(due), 'dd/MM/yyyy');
        this.tasks = [];
        projects.push(this);
    }
...
// Create new tasks
const task1 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 1', 'May 13, 2023', 'Medium', 'Do this task first');
const task2 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 2', 'May 17, 2023', 'High', 'This task is urgent');
const task3 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 3', 'May 28, 2023', 'Low', 'Not a priority');
const task4 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 4', 'June 5, 2023', 'High', 'Needs to be completed before project deadline');
const task5 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 5', 'June 25, 2023', 'Medium', 'Some urgency, but not critical');
const task6 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 6', 'July 7, 2023', 'High', 'Critical task for project success');
const task7 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 7', 'August 1, 2023', 'Low', 'Not a priority, but needs to be done eventually');
const task8 = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('Task 8', 'August 20, 2023', 'Medium', 'Some urgency, but can wait');
