...
function createProjectForm(toDoList) {
    ...
    addTaskButton.addEventListener('click', (e) => {
        tasksCounter += 1;
        (0,_createTaskForm__WEBPACK_IMPORTED_MODULE_3__.createTaskForm)(toDoList, tasksCounter);
    })
...
// Create new tasks
const task1 = new _tasks__WEBPACK_IMPORTED_MODULE_2__.Task('Task 1', 'May 13, 2023', 'Medium', 'Do this task first');
...
const task5 = new _tasks__WEBPACK_IMPORTED_MODULE_2__.Task('Task 5', 'June 25, 2023', 'Medium', 'Some urgency, but not critical');
...
const task8 = new _tasks__WEBPACK_IMPORTED_MODULE_2__.Task('Task 8', 'August 20, 2023', 'Medium', 'Some urgency, but can wait');
